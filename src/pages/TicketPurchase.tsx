          ...
          <div className="space-y-3">
            <div>
              <p className="text-sm font-semibold text-foreground mb-2">
                Descubra ofertas e serviços adicionais para seu pedido
              </p>
              <Button 
                variant="outline" 
                className="w-full"
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1 space-y-2">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  ...
                  <p className="text-[10px]">Promotor: KINGS WORLD CUP BRASIL LTDA</p>
                </div>
              </div>
        ...
        <div className="space-y-3">
          ...
          <Card className="p-4 border-2">
            ...
            <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
              Esse seguro protege dentro de critérios específicos cobertos pela apólice: o reembolso do valor dos ingressos e cobertura de até R$ 2.000,00 em caso de roubo e furto do celular.
            </p>
          </Card>
        </div>
        ...
        <Card className="p-4 border-2 bg-muted/30">
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">1 × KINGS WORLD CUP NATIONS - FINAL</span>
